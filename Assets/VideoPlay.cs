...
public class VideoPlay : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        slid.onValueChanged.AddListener(delegate
        {
            ...
            video.time = slid.value * video.clip.length; //  
        });
    ...
    void nowtime()
    {
        ...
        slid.value = (float)((float)video.time / video.clip.length);
    }
    void alltime()
    {
        // clipHour = (int)aus.clip.length / 3600;
        clipHour = (int)video.clip.length / 3600;

        //clipMinute = (int)(aus.clip.length - clipHour * 3600) / 60; 
        clipMinute = (int)(video.clip.length - clipHour * 3600) / 60;

        //clipSecond = (int)(aus.clip.length - clipHour * 3600 - clipMinute * 60);
        clipSecond = (int)(video.clip.length - clipHour * 3600 - clipMinute * 60);
